...
Project Title:
View of Small village 

Features & Description

In this village there are a house ,some  trees, boat, sun, moon, flowers, river, boat, cloud ,birds etc.


If you press D/d, it shows day view . Or you press N/n, it shows night view
...
void StartingText()
{
    ...
    for(int i = 0; text[i] != '\0'; i++)
    {
        ...
        sprintf(text,"  ABDULLAH AL FAHMEE",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {

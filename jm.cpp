...
void timer(int value) {
    if (currentScene < 4) {
        ...
        // After scene 4, execute another program
        int returnValue = system("F:\\proggaming\\Computer-Graphics-main\\OpenGL Programming\\jimmy5.2.exe");
        ...
        if (returnValue == 0) {
            ...
            std::cerr << "Error executing the program!" << std::endl;
        }
    }
    glutPostRedisplay();
